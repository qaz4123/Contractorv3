    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card padding="sm">
          ...
          <p className="text-2xl font-semibold">{formatCurrency(stats?.totalInvoiced || 0)}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Paid</p>
          <p className="text-2xl font-semibold text-green-600">{formatCurrency(stats?.totalPaid || 0)}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Outstanding</p>
          <p className="text-2xl font-semibold text-yellow-600">{formatCurrency(stats?.totalOutstanding || 0)}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Overdue</p>
          <p className="text-2xl font-semibold text-red-600">{formatCurrency(stats?.totalOverdue || 0)}</p>
        </Card>
      </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          icon={<DollarSign className="w-12 h-12 text-red-400" />}
