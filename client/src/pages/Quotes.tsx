    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card padding="sm">
          ...
          <p className="text-2xl font-semibold text-yellow-600">{data?.stats?.pending || 0}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Accepted</p>
          <p className="text-2xl font-semibold text-green-600">{data?.stats?.accepted || 0}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Total Value</p>
          <p className="text-2xl font-semibold">{formatCurrency(data?.stats?.totalValue || 0)}</p>
        </Card>
      </div>
