    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card padding="sm">
          ...
          <p className="text-2xl font-semibold text-blue-600">{data?.stats?.inProgress || 0}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Completed</p>
          <p className="text-2xl font-semibold text-green-600">{data?.stats?.completed || 0}</p>
        </Card>
        <Card padding="sm">
          <p className="text-sm text-gray-500">Total Budget</p>
          <p className="text-2xl font-semibold">{formatCurrency(data?.stats?.totalBudget || 0)}</p>
        </Card>
      </div>
